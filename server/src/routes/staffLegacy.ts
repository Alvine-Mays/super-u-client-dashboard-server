...
export async function mountStaffRoutes(app: Express) {
  ...
  // Step 1: staff validates temporary code and generates final code (sent to customer)
  app.post('/api/staff/validate-code', async (req: Request, res: Response) => {
    try {
  ...
  // Step 2: staff verifies final code to complete pickup
  app.post('/api/staff/verify-final-code', async (req: Request, res: Response) => {
    try {
